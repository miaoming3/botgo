...
![Build](https://github.com/miaoming3/botgo/actions/workflows/build.yml/badge.svg)
[![Go Reference](https://pkg.go.dev/badge/github.com/miaoming3/botgo.svg)](https://pkg.go.dev/github.com/miaoming3/botgo)
[![Examples](https://img.shields.io/badge/BotGo-examples-yellowgreen)](https://github.com/miaoming3/botgo/tree/master/examples)
...
另外，也有其他同事基于 etcd 实现了 shard 集群的管理，在 [botgo-plugns](https://github.com/miaoming3/botgo-plugins) 中。
